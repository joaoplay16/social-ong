...
export default class App extends React.Component {
 ...
 loadPadrinho = async () => {
     const respons = await api.get('/ListaPreto1'); //buscar dos dados no banco
     this.setState({Preto: respons.data }); // setando o estado de Pu.At. com informações da lista do banco 

     const response = await api.get('/ListaPreto2'); //buscar dos dados no banco
     this.setState({Preto1: response.data }); // setando o estado de Pu.At. com informações da lista do banco 

     const respon = await api.get('/ListaPreto3'); //buscar dos dados no banco
